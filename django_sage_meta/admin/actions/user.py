...
from django_sage_meta.models import UserData, FacebookPageData,InstagramAccount
...
def fetch_and_save_user_data(modeladmin, request, queryset):
    ...
    user_data.save()
    modeladmin.message_user(request, "User Data and Pages have been fetched and saved successfully.")
