...
from django_sage_meta.models import InstagramAccount, Media
...
def fetch_and_save_instagram_accounts(modeladmin, request, queryset):
    ...
    for account in accounts:
        media_obj = Media.objects.filter(
    ...
    modeladmin.message_user(
        request, "Media and comments have been fetched and saved successfully."
    )


fetch_and_save_instagram_accounts.short_description = (
    "Fetch and Save Instagram Business Accounts from Facebook"
)
