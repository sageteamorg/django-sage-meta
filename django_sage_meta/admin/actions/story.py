...
def fetch_and_save_stories(modeladmin, request, queryset):
    ...
    try:
        ...
        modeladmin.message_user(request, "Stories have been fetched and saved successfully.")
    except IntegrityError as e:
        modeladmin.message_user(request, f"Database integrity error: {e}", level='error')
    except Exception as e:
        modeladmin.message_user(request, f"Error fetching and saving stories: {e}", level='error')
